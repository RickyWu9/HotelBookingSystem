<template>
    <a-modal
        :visible="addManagerModelVisible"
        title="添加用户"
        cancelText="取消"
        okText="确定"
        @cancel="cancel"
...
export default {
    ...
    computed: {
        ...mapGetters([
            'addManagerModelVisible',
            'managerList',
        ])
    },
    beforeCreate() {
        this.form = this.$form.createForm(this, { name: 'addManagerModel' });
    },
    mounted() {
    ...
    methods: {
        ...
        cancel() {
            this.set_addManagerModelVisible(false)
        },
